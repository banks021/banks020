...
const menu = async (m, Matrix) => {
  ...
  if (validCommands.includes(cmd)) {
    const mainMenu = `
╭─❒ 「 ${toFancyFont("Banks-MD")} Command Menu 🌟 」
│
│ 🤖 *${toFancyFont("Bot")}*: ${toFancyFont("Banks-MD")}
...
╰─────────────
 ...
 ${pushwish} @*${m.pushName}*! Tap a button to explore a menu category:
...
`;
    ...
    const fullResponse = `
╭─❒ 「 ${toFancyFont("Banks-MD")} - ${toFancyFont(menuTitle)} 🌟 」
│
│ 🤖 *${toFancyFont("Bot")}*: ${toFancyFont("Banks-MD")}
